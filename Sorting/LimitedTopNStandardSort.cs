...
namespace Sorting
{
    public class LimitedTopNStandardSort<T> : ITopNSort<T> where T : IComparable<T>
    {
        public string Name { get { return "Limited TopN Sort"; } }
        ...
        public T[] TopNSort(T[] inputOutput, int n, IComparer<T> comparer)
        {
            ...
            return ParallelTopNSort(inputOutput, n, comparer, 4);
